...
{raw_input}
Parsed Application Details: {json.dumps(parsed_form or {})}
...
## 5. Sources Used
[Table of all retrieved sources with document name, type, clause, page, and download link]

## 6. Disclaimer
AI-Generated Draft for Research Assistance Only. This response is generated by an AI assistant to help
legal officers research and prepare draft opinions. It does not constitute a legally binding opinion and
must not be relied upon as such. The officer must exercise professional judgment, verify all citations,
and ensure compliance with applicable laws before finalizing any decision."""
